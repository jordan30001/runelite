...
public class BlenderPlugin extends Plugin {
    ...
    private JsonObject getCamera(JsonObject parent) {
        ...
        cameraJSON.addProperty("ocuFocalPointX", "" + client.getOculusOrbFocalPointX());
        cameraJSON.addProperty("ocuFocalPointY", "" + client.getOculusOrbFocalPointY());
        cameraJSON.addProperty("localPlayer", "" + client.getLocalPlayer().getLocalLocation());
